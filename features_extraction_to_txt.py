...
with open("data/features_all.txt", "w", newline="") as csvfile:
    ...
    for person in range(person_cnt):
        ...
        print('\n')
    print("所有录入人脸数据存入 / Save all the features of faces registered into: data/features_all.txt")